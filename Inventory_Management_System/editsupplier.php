<?php
    ...
    if(isset($_POST['submit']))
    {
       ...
       $phone=$_POST['phone'];
       $email=$_POST['email'];
       $query="update Supplier set Sup_id='$rn',Sup_name='$Supplier_name',Phone='$phone',Email='$email',Address='$address' where Sup_id='$rn'";
                            ...
                            <form action="" name="form1" method="POST">
                              <div class="form-group">
                                 <label for="pwd">Customername</label>
                                    <input type="varchar" class="form-control" value="<?php echo "$fn"?>" id="item_name" placeholder="enter item name" name="supplier_name">
                              </div>
                               <div class="form-group">
