...
<body class="animsition">
                            ...
                            <h2>Add Mobiles</h2>
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="varchar" class="form-control" id="Categories" size="50px" value="Mobiles" placeholder="Enter item Category" name="Categories" required>
                                </div>
                                <div class="form-group">
    ...
    <tbody>
        <?php
            $res= mysqli_query($link,"select * from Items where Categories='Mobiles'");
            while($result=mysqli_fetch_assoc($res))
            {
                ...
                <td><a href='editmobiles.php?ca=$result[Item_id]&cn=$result[Item_name]&ad=$result[Categories]&ph=$result[Item_price]'>Edit</td>
                <td><a href='deleteitems.php?ca=$result[Item_id]' onclick='return check()'>delete</td>
             </tr>";
            }
        ?>
    </tbody>
