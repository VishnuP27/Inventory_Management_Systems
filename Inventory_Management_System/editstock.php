<?php
    ...
    {
       $stock=$_POST['stock'];
       $query="update Supply set Sup_id='$rn',Item_id='$fn',Stock='$stock' where Sup_id='$rn' and Item_id='$fn'";
                            ...
                            <form action="" name="form1" method="POST">
                              <div class="form-group">
                                 <label for="pwd">Stocks</label>
                                    <input type="varchar" class="form-control" value="<?php echo "$ln"?>" id="stock" placeholder="enter Updates Stock" name="stock">
                              </div>
