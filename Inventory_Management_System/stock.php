...
<body class="animsition">
                            ...
                            <h2>Add Stock</h2>
                               <form action="" name="form1" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="varchar" class="form-control" id="Item_id" size="50px" placeholder="Enter Item id" name="Item_id">
                                </div>
                                <div class="form-group">
                                    <label for="pwd">Stocks</label>
                                    <input type="varchar" class="form-control" id="Stocks" size="50px" placeholder="Enter the Stocks" name="Stock">
                                </div>
    ...
    <tbody>
        <?php
            $res= mysqli_query($link,"select * from Supply");
            while($result=mysqli_fetch_assoc($res))
            {
                ...
                <td>" .$result['Stock']."</td>
                <td><a href='editstock.php?ci=$result[Sup_id]&cn=$result[Item_id]&ad=$result[Stock]'>Edit</td>
                <td><a href='deletestock.php?ci=$result[Sup_id]&cn=$result[Item_id]' onclick='return check()'>delete</td>
             </tr>";
            }
        ?>
    </tbody>
...
<?php
    ...
    {
        mysqli_query($link,"insert into Supply values('$_POST[Sup_id]','$_POST[Item_id]','$_POST[Stock]')");
        ?>
