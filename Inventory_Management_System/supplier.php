                         ...
                         <div class="col-lg-12">
                            <h2>Add Supplier</h2>
                               ...
                               <div class="form-group">
                                    <label for="pwd">Supplier id</label>
                                    <input type="int" class="form-control" id="Sup_id" size="50px" placeholder="Enter Supplier id" name="Sup_id">
                                </div>
                                <div class="form-group">
                                    <label for="pwd">Supplier name</label>
                                    <input type="varchar" class="form-control" id="Sup_name" size="50px" placeholder="Enter Supplier Name" name="Sup_name">
                                </div>
                                <div class="form-group">
    ...
    <tbody>
        <?php
            ...
            while($result=mysqli_fetch_assoc($res))
            {
                ...
                <td>" .$result['Phone']."</td>
                <td>" .$result['Email']."</td>
                <td><a href='editsupplier.php?si=$result[Sup_id]&sn=$result[Sup_name]&ad=$result[Address]&ph=$result[Phone]&em=$result[Email]'>Edit</td>
                <td><a href='deleteSup.php?si=$result[Sup_id]' onclick='return check()'>delete</td>
             </tr>";
            }
        ?>
    </tbody>
...
<?php
    ...
    {
        mysqli_query($link,"insert into Supplier values('$_POST[Sup_id]','$_POST[Sup_name]','$_POST[Address]','$_POST[Phone]','$_POST[Email]')");
        ?>
