<?php
    ...
    if(isset($_POST['submit']))
    {
       ...
       $phone=$_POST['phone'];
       $email=$_POST['email'];
       $query="update Customer set Cust_id='$rn',Cust_name='$Customer_name',Phone='$phone',Address='$address',Email='$email' where Cust_id='$rn'";
                         ...
                         <div class="col-lg-4">
                            ...
                            <form action="" name="form1" method="POST">
                              <div class="form-group">
                                 <label for="pwd">Customername</label>
                                    <input type="varchar" class="form-control" value="<?php echo "$fn"?>" id="item_name" placeholder="enter item name" name="customer_name">
                              </div>
                               <div class="form-group">
                                 <label for="pwd">Customer phone</label>
                                    <input type="varchar" class="form-control" value="<?php echo "$em"?>" id="ite_quantity" placeholder="Categories" name="phone">
                               </div>
                               <div class="form-group">
                                  <label for="pwd">Address</label>
                                    <input type="varchar" class="form-control" value="<?php echo "$ln"?>" id="item_price" placeholder="enter item price" name="Address">
                               </div>
                               <div class="form-group">
                                  <label for="pwd">Email</label>
                                    <input type="varchar" class="form-control" value="<?php echo "$ph"?>" id="item_price" placeholder="enter item price" name="email">
                               </div>
