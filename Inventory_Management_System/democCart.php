...
<?php
    ...
    $con = mysqli_connect("localhost","1CR19CS070","hrk1cr19cs070",$database_name);
...
<body>
    ...
    <div class="container" style="width: 65%">
        <h2>Shopping Cart</h2>
        <?php
            $query = "select distinct i.*,Stock as Stock,d.Sup_id as Sup_id from Items i,Supply s,dummySupplier d where i.Item_id=s.Item_id";
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="Cart.php?action=add&id=<?php echo $row["Item_id"]; ?>">
                            ...
                            <div class="product">
                                ...
                                <input type="hidden" name="hidden_supid" value="<?php echo $row["Sup_id"]; ?>">
        ...
        <div class="table-responsive">
            ...
            <?php
                if(!empty($_SESSION["cart"])){
                    ...
                    mysqli_query($con,"insert into dummycart(itemid,quantity,price,sup_id) values($value[product_id],$value[item_quantity],$total,$value[sup_id])");
