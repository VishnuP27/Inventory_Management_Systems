<?php
    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="democart.php"</script>';
    ...
    $rn=$_GET["id"];
    $kn=$_POST["hidden_supid"];
    if (isset($_GET["action"])){
        if ($_GET["action"] == "delete"){
            foreach ($_SESSION["cart"] as $keys => $value){
                if ($value["product_id"] == $rn){
                    unset($_SESSION["cart"][$keys]);
                    mysqli_query($con,"delete from Cart where Item_id=$rn");
        ...
        if ($_GET["action"] == "delet"){
            foreach ($_SESSION["cart"] as $keys => $value){
                if ($value["product_id"] == $rn){
                    unset($_SESSION["cart"][$keys]);
                    mysqli_query($con,"insert into Orders values('$kn','$rn')");
                    mysqli_query($con,"update Cart set Order_id=(select Ord_id from Orders where Total_price='$rn')");
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <h2>Shopping Cart</h2>
        <?php
            $query = "SELECT distinct i.*,Stock as Stock,c.Cust_id FROM Customer,Supply s,Items i where s.Item_id=i.Item_id ORDER BY Item_id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="democart.php?action=add&id=<?php echo $row["Item_id"]; ?>">
                            ...
                            <div class="product">
                                ...
                                <input type="hidden" name="hidden_supid" value="<?php echo $row["Cust_id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="democart.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
                        ...
                        <tr>
                            ...
                            <td><a href="democart.php?action=delet&id=<?php echo $value['product_id']; ?>"><span
