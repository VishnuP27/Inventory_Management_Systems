    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="dc.php"</script>';
            }else{
...
<div class="page-wrapper">
    ...
    <div class="container" style="width: 65%">
        <h2>Shopping Cart</h2>
        <?php
            $query = "SELECT i.*,Stock as Stock FROM Supply s,Items i where s.Item_id=i.Item_id ORDER BY Item_id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="dc.php?action=add&id=<?php echo $row["Item_id"]; ?>">
                            ...
                            <div class="product">
                                ...
                                <input type="text" name="custid" class="form-control" placeholder="Enter the Customerid">
