...
<body class="animsition">
            ...
            <div class="col-lg-12">
                            <h2>Add Item</h2>
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="pwd">required stocks</label>
                                    <input type="varchar" class="form-control" id="item_name" size="50px" placeholder="enter no of stocks" name="Stocks" required>
                                </div>
                                <div class="form-group">
                                    <label for="pwd">item id</label>
                                    <input type="int" class="form-control" id="price" size="50px" placeholder="enter item id" name="price" required>
                                </div>
                                <div class="form-group">
                                    <label for="pwd">required stocks</label>
                                    <input type="varchar" class="form-control" id="sup" size="50px" placeholder="enter no of stocks" name="sup" required>
                                </div>
                                <div class="form-group">
                                    <label for="pwd">required stocks</label>
                                    <input type="varchar" class="form-control" id="cartid" size="50px" placeholder="enter no of stocks" name="cartid" required>
                                </div>
    ...
    if(isset($_POST["submit"]))
    {
        ...
        mysqli_query($link,"insert into cart values('$_POST[cartid]','$_POST[Stocks]','$_POST[price]','$_POST[item_id]','$_POST[sup]')");
        ?>
